...
public:
	...
	int SelectCMDByAntenna(unsigned char *address,
	...
	int SetCustomRegion(unsigned char *address,unsigned char FLAG,unsigned char freSpace,unsigned char freNum,unsigned char *freStart);
	int GetCustomRegion(unsigned char *address,unsigned char *freSpace,unsigned char *freNum,unsigned char *freStart);
