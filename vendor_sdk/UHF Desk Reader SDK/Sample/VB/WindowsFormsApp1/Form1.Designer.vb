Namespace WindowsFormsApp1
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' groupNet
			' 
			Me.groupNet.Anchor = (CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
...
'ORIGINAL LINE: this.btnDisConnect.Click += new System.EventHandler(this.btnDisConnect_Click);
			' 
			' btnConnect
			' 
...
'ORIGINAL LINE: this.btnConnect.Click += new System.EventHandler(this.btnConnect_Click);
			...
			' txbPort
			' 
			Me.txbPort.Anchor = (CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
			...
			' txbIPAddr
			' 
			Me.txbIPAddr.Anchor = (CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
			...
			' gpbCom
			' 
			Me.gpbCom.Anchor = (CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
			...
			' cmbComBaud
			' 
			Me.cmbComBaud.Anchor = (CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnSportClose.Click += new System.EventHandler(this.btnSportClose_Click);
			' 
			' btnSportOpen
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnSportOpen.Click += new System.EventHandler(this.btnSportOpen_Click);
			' 
			' cmbComPort
			' 
			Me.cmbComPort.Anchor = (CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.cmbComPort.DropDown += new System.EventHandler(this.cmbComPort_DropDown);
			' 
			' label2
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnSetTxPower.Click += new System.EventHandler(this.btnSetTxPower_Click);
			' 
			' label1
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnSetWorkMode.Click += new System.EventHandler(this.btnSetWorkMode_Click);
			' 
			' lsvTagsActive
			' 
			Me.lsvTagsActive.Anchor = (CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) Or System.Windows.Forms.AnchorStyles.Left) Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
			...
			Me.lsvTagsActive.Location = New System.Drawing.Point(10, 285)
			Me.lsvTagsActive.Name = "lsvTagsActive"
			Me.lsvTagsActive.Size = New System.Drawing.Size(618, 360)
			...
			Me.btnInventory.Font = New System.Drawing.Font("黑体", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, (CByte(134)))
			Me.btnInventory.Location = New System.Drawing.Point(357, 217)
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnInventory.Click += new System.EventHandler(this.btnInventoryActive_Click);
			' 
			' btninvStop
			' 
			...
			Me.btninvStop.Font = New System.Drawing.Font("黑体", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, (CByte(134)))
			Me.btninvStop.Location = New System.Drawing.Point(509, 217)
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btninvStop.Click += new System.EventHandler(this.btninvStop_Click);
			' 
			' btnClear
			' 
...
'ORIGINAL LINE: this.btnClear.Click += new System.EventHandler(this.btnClear_Click);
			...
			' stdSerialData
			' 
			Me.stdSerialData.Anchor = (CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnGetTxPower.Click += new System.EventHandler(this.btngetTxPower_Click);
			' 
			' btnGetWorkMode
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnGetWorkMode.Click += new System.EventHandler(this.btnGetWorkMode_Click);
			' 
			' label4
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.cmbRegion.SelectedValueChanged += new System.EventHandler(this.cmbRegion_SelectedValueChanged);
			' 
			' cmbFreqStart
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.cmbFreqStart.SelectedIndexChanged += new System.EventHandler(this.cmbFreqStart_SelectedIndexChanged);
			' 
			' cmbFreqEnd
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnGetFreq.Click += new System.EventHandler(this.btnGetFreq_Click);
			' 
			' btnSetFreq
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnSetFreq.Click += new System.EventHandler(this.btnSetFreq_Click);
			' 
			' groupBox1
			' 
			...
			Me.groupBox1.Location = New System.Drawing.Point(231, 122)
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.Close_Realy.Click += new System.EventHandler(this.Close_Realy_Click);
			' 
			' Release_Realy
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.Release_Realy.Click += new System.EventHandler(this.Release_Realy_Click);
			' 
			' groupusb
			' 
			...
			Me.groupusb.Location = New System.Drawing.Point(9, 125)
			Me.groupusb.Name = "groupusb"
			Me.groupusb.Size = New System.Drawing.Size(216, 114)
			...
			' btnScanUsb
			' 
			Me.btnScanUsb.Location = New System.Drawing.Point(15, 43)
			Me.btnScanUsb.Name = "btnScanUsb"
			Me.btnScanUsb.Size = New System.Drawing.Size(74, 28)
			Me.btnScanUsb.TabIndex = 90
			Me.btnScanUsb.Text = "ScanUSB"
			Me.btnScanUsb.UseVisualStyleBackColor = True
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnScanUsb.Click += new System.EventHandler(this.btnScanUsb_Click);
			' 
			' btnUSBopen
			' 
			Me.btnUSBopen.Anchor = System.Windows.Forms.AnchorStyles.Top
			Me.btnUSBopen.Location = New System.Drawing.Point(14, 76)
			Me.btnUSBopen.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
			Me.btnUSBopen.Name = "btnUSBopen"
			Me.btnUSBopen.Size = New System.Drawing.Size(74, 28)
...
'ORIGINAL LINE: this.btnUSBClose.Click += new System.EventHandler(this.btnUSBClose_Click);
			...
			Me.cmbOutInterface.Location = New System.Drawing.Point(341, 96)
			Me.cmbOutInterface.Name = "cmbOutInterface"
			Me.cmbOutInterface.Size = New System.Drawing.Size(82, 20)
			...
			Me.btnGetOutInterface.Location = New System.Drawing.Point(457, 94)
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnGetOutInterface.Click += new System.EventHandler(this.btnGetOutInterface_Click);
			' 
			' btnSetOutInterface
			' 
			...
			Me.btnSetOutInterface.Location = New System.Drawing.Point(547, 93)
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnSetOutInterface.Click += new System.EventHandler(this.btnSetOutInterface_Click);
			' 
			' label7
			' 
			Me.label7.Anchor = (CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles))
			Me.label7.AutoSize = True
			Me.label7.Location = New System.Drawing.Point(239, 99)
