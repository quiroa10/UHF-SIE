...
extern "C" {
	...
	UHFREADER288_API int SelectCMDByAntenna(unsigned char *address,
	...
	UHFREADER288_API int SetCustomRegion(unsigned char *address,unsigned char FLAG,unsigned char freSpace,unsigned char freNum,unsigned char *freStart,int FrmHandle);
	UHFREADER288_API int GetCustomRegion(unsigned char *address,unsigned char *freSpace,unsigned char *freNum,unsigned char *freStart,int FrmHandle);
